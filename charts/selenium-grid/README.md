...
| -----------------------------------   | ---------------------------------- | ------------------------------------- |
| `global.seleniumGrid.imageTag`        | `4.8.0-20230123`                   | Image tag for all selenium components |
| `global.seleniumGrid.nodesImageTag`   | `4.8.0-20230123`                   | Image tag for browser's nodes         |
...
| `chromeNode.imageTag`                   | `4.8.0-20230123`                   | Image of chrome nodes                                                                                                      |
...
| `firefoxNode.imageTag`                  | `4.8.0-20230123`                   | Image of firefox nodes                                                                                                     |
...
| `edgeNode.imageTag`                     | `4.8.0-20230123`                   | Image of edge nodes                                                                                                        |
