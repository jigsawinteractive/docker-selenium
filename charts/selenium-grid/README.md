...
| -----------------------------------   | ---------------------------------- | ------------------------------------- |
| `global.seleniumGrid.imageTag`        | `4.7.1-20221208`                   | Image tag for all selenium components |
| `global.seleniumGrid.nodesImageTag`   | `4.7.1-20221208`                   | Image tag for browser's nodes         |
...
| `chromeNode.imageTag`                   | `4.7.1-20221208`                   | Image of chrome nodes                                                                                                      |
...
| `firefoxNode.imageTag`                  | `4.7.1-20221208`                   | Image of firefox nodes                                                                                                     |
...
| `edgeNode.imageTag`                     | `4.7.1-20221208`                   | Image of edge nodes                                                                                                        |
